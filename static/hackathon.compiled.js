		...
		React.createElement(
			Button,
			{
				...
				onClick: function onClick() {
					return window.open(
						'https://hackathonbfs.typeform.com/to/fD5rzJ'
					);
				}
			},
			'Apply Now!'
...
function Warning(props) {
	return React.createElement(
		...
		React.createElement(
			Title,
			{ center: true, style: { color: 'red' } },
			React.createElement(
				'a',
				{ className: 'anchor', id: 'covid-19' },
...
function Menu(props) {
	...
	return React.createElement(
		...
		React.createElement(
			...
			React.createElement(
				'i',
				{ className: 'material-icons', style: { height: '100%' } },
				'keyboard_arrow_',
				open ? 'right' : 'left'
			)
		),
...
function GridCell(_ref6) {
	...
	if (spanTablet)
		classes.push(
			'mdc-layout-grid__cell--span-'.concat(spanTablet, '-tablet')
		);
	return React.createElement(
		'div',
...
function SponsorCell(_ref7) {
	...
	return React.createElement(
		GridCell,
		{ span: span, spanTablet: spanTablet, style: cellStyles },
...
function Venue() {
	...
	return React.createElement(
		...
		React.createElement(
			...
			React.createElement(
				GridCell,
				{ span: 6, spanTablet: 8, style: { height: '24rem' } },
				React.createElement('img', {
					src: '/venue.jpg',
...
function VenueMap() {
	return React.createElement(
		'div',
		{ id: 'map-container', className: 'z-depth-1-half map-container' },
...
function FAQs() {
	return React.createElement(
		...
		React.createElement(QuestionBox, {
			question:
				'What if I don\u2019t understand blockchain technology or know how to develop applications using it?',
			answer: React.createElement(
				'span',
				null,
				'Don\u2019t worry! We will be having extended ',
				React.createElement('b', null, '3-hour workshops'),
		...
		React.createElement(QuestionBox, {
			...
			answer: React.createElement(
				...
				React.createElement(
					'b',
					null,
					'Please note a college team is defined as a team with at least one (1) college student on it, and teams whose members are all high school students constitute as a high school team.'
				)
			)
		}),
		React.createElement(QuestionBox, {
			...
			answer: React.createElement(
				...
				React.createElement('b', null, 'guaranteed'),
		...
		React.createElement(QuestionBox, {
			...
			answer: React.createElement(
				...
				React.createElement('b', null, 'Execute Big'),
				' to provide travel reimbursements! Once you fill out the form and we determine you\u2019re eligible, your information be passed on to them for consideration (if you apply through Regular or Late)! If you are accepted, congratulations! You\u2019ll be covered at least in part by Execute Big. If you aren\u2019t accepted, you will then be considered for reimbursement by our team.',
				React.createElement('br', null),
				React.createElement('br', null),
