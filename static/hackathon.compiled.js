...
function App() {
  ...
  return React.createElement(
      'div', null, React.createElement(Warning, null),
      React.createElement(About, null), React.createElement(Sponsors, null),
      React.createElement(Venue, null), React.createElement(Schedule, null),
      React.createElement(FAQs, null), React.createElement(Menu, null),
...
function Warning(props) {
  return React.createElement(
      Container, null,
      React.createElement(
          Title, {center : true, style : {color : 'red'}},
          React.createElement('a', {className : 'anchor', id : 'covid-19'},
                              'ATTN: HACKATHON POSTPONED')),
      React.createElement(
          'p', {style : {color : 'red'}},
          React.createElement(
              'b', null, 'Hi all,', React.createElement('br', null),
              React.createElement('br', null),
...
function Menu(props) {
  var tabs = [
    {anchor : '#covid-19', title : 'COVID-19'},
    {anchor : '#about', title : 'About'},
    {anchor : '#sponsors', title : 'Sponsors'},
    {anchor : '#venue', title : 'Venue'},
    {anchor : '#schedule', title : 'Schedule'},
    {anchor : '#faqs', title : 'FAQs'}
  ];

  var _React$useState = React.useState(window.innerWidth > 850),
      _React$useState2 = _slicedToArray(_React$useState, 2),
      open = _React$useState2[0], setOpen = _React$useState2[1];

  var _React$useState3 = React.useState(''),
      _React$useState4 = _slicedToArray(_React$useState3, 2),
      currentTab = _React$useState4[0], setCurrentTab = _React$useState4[1];
  ...
  return React.createElement(
      ...
      React.createElement(
          ...
          React.createElement(
              'i', {className : 'material-icons', style : {height : '100%'}},
      ...
      React.createElement(
          ...
          tabs.map(function(tab) {
            return React.createElement(
                MenuItem,
                {tab : tab.anchor, active : currentTab === tab.anchor},
                tab.title);
          })));
}

function MenuItem(_ref) {
  var tab = _ref.tab, active = _ref.active, children = _ref.children;
  return React.createElement(
      'p', null,
...
function Button(_ref2) {
  var children = _ref2.children, style = _ref2.style, onClick = _ref2.onClick;
  ...
  return React.createElement(
      ...
      React.createElement('span', {className : 'mdc-button__ripple'}),
      children);
}
...
function Title(_ref4) {
  var children = _ref4.children, center = _ref4.center,
  ...
  return React.createElement('h2', {style : styles}, children);
}
...
function About() {
  return React.createElement(
      ...
      React.createElement(
          Title, {center : true},
          React.createElement('a', {className : 'anchor', id : 'about'},
                              'About')),
      React.createElement(
          'p', null,
...
function Grid(_ref5) {
  ...
  return React.createElement(
      ...
      React.createElement('div', {className : 'mdc-layout-grid__inner'},
                          children));
}

function GridCell(_ref6) {
  var span = _ref6.span, spanTablet = _ref6.spanTablet,
      children = _ref6.children, style = _ref6.style,
      className = _ref6.className;
  var classes = [ 'mdc-layout-grid__cell--span-' + (span || 4) ];
  if (className)
    classes.push.apply(classes, _toConsumableArray(className));
  if (spanTablet)
    classes.push('mdc-layout-grid__cell--span-'.concat(spanTablet, '-tablet'));
  return React.createElement(
      'div', {className : classes.join(' '), style : style}, children);
}

function SponsorCell(_ref7) {
  var alt = _ref7.alt, src = _ref7.src, span = _ref7.span,
      spanTablet = _ref7.spanTablet, url = _ref7.url, width = _ref7.width;
  var imageStyles = {
    maxWidth : '100%',
    width : width,
    height : '100%',
  ...
  return React.createElement(
      ...
      React.createElement('img', {
        ...
        alt : alt,
        src : src,
        onClick : function onClick() { return window.open(url); }
      }));
}
...
function Sponsors() {
  return React.createElement(
      ...
      React.createElement(
          Title, {center : true},
          React.createElement('a', {className : 'anchor', id : 'sponsors'},
                              'Sponsors')),
      React.createElement(Grid, {style : ''}, React.createElement(SponsorCell, {
        alt : 'Microsoft Logo',
      ...
      React.createElement(Title, {center : true}, 'Community Partners'),
      React.createElement(
          Grid, null,
          React.createElement(GridCell,
                              {span : 4, className : [ 'desktop-only' ]}),
      ...
      React.createElement(Title, {center : true}, 'Travel Sponsors'),
      React.createElement(
          Grid, null,
          React.createElement(GridCell,
                              {span : 2, className : [ 'desktop-only' ]}),
          React.createElement(SponsorCell, {
      ...
      React.createElement(
          ...
          React.createElement(
              'b', null,
              'If you are interested in sponsoring/partnering with us for the hackathon, please email us at ',
              React.createElement(
...
function Venue() {
  ...
  return React.createElement(
      ...
      React.createElement(
          Title, {center : true},
          React.createElement('a', {className : 'anchor', id : 'venue'},
                              'Venue')),
      React.createElement(
          'p', null,
          React.createElement(
              'b', null,
              'Our venue is located at Microsoft Times Square (11 Times Square, New York, NY 10036).')),
      React.createElement(
          'p', null,
...
function VenueMap() {
  return React.createElement(
      ...
      React.createElement('iframe', {
        src :
            'https://maps.google.com/maps?q=microsoft%20times%20square&t=&z=13&ie=UTF8&iwloc=&output=embed',
        frameBorder : '0',
...
function Schedule() {
  return React.createElement(
      ...
      React.createElement(
          Title, {center : true},
          React.createElement('a', {className : 'anchor', id : 'schedule'},
                              'Schedule')),
      React.createElement(
          'p', {className : 'text-center'},
...
function QuestionBox(_ref8) {
  var question = _ref8.question, answer = _ref8.answer;

  var _React$useState5 = React.useState(false),
      _React$useState6 = _slicedToArray(_React$useState5, 2),
      open = _React$useState6[0], setOpen = _React$useState6[1];
  ...
  var iconStyles = {position : 'absolute', right : '1rem'};
  var answerStyles = {
  ...
  return React.createElement(
      ...
      React.createElement(
          ...
          React.createElement('a', null,
                              React.createElement('b', null, question)),
          React.createElement(
              'i', {style : iconStyles, className : 'material-icons'},
              'arrow_drop_', open ? 'up' : 'down')),
      React.createElement('p', {style : answerStyles}, answer));
}
  ...
  return React.createElement(Container, null,
                             ...
                             React.createElement(QuestionBox, {
                               ...
                               answer : React.createElement(
                                   'span', null,
                                   'A hackathon is a gathering where you can come together with other engineers, programmers, and cool people to turn your ideas into a real project in 24 hours. You take care of hacking, programming, creativity, and having a good time. We provide the venue, mentors, fun activities, speakers, workshops, food, friends, and almost everything you\u2019ll ever need. ')
                             }),
                             React.createElement(QuestionBox, {
                               question : 'Who can participate in B4H?',
                               answer : React.createElement(
                                   'span', null,
                                   'Anyone enrolled as a student can attend! (That includes both high school and college students!) Students with an interest in blockchain technology are highly encouraged to apply! Whether you\u2019re a beginner or experienced, this is the hackathon for you!',
                                   React.createElement('br', null),
                                   React.createElement('br', null),
                                   'If you\u2019re a beginner, don\u2019t worry! We have you covered (see below).')
                             }),
                             React
                                 .createElement(
                                     QuestionBox, {
                                       ...
                                       answer :
                                           React.createElement('span',
                                                               null, 'Don\u2019t worry! We will be having extended ',
                                                               React
                                                                   .createElement('b',
                                                                                  null, '3-hour workshops'),
                             ...
                             React
                                 .createElement(
                                     QuestionBox, {
                                       ...
                                       answer :
                                           React.createElement('span',
                                                               null, 'Don\u2019t worry! We\u2019ll host teambuilding sessions before the extended workshops start.',
                                                               React
                                                                   .createElement('br',
                                                                                  null),
                                                               ...
                                                               React.createElement('b',
                                                                                   null, 'Please note a college team is defined as a team with at least one (1) college student on it, and teams whose members are all high school students constitute as a high school team.'))
                                     }),
                             React.createElement(QuestionBox, {
                               ...
                               answer : React
                                            .createElement(
                                                'span',
                                                null,
                                                'We actually have three application rounds: Early, Regular, and Late! Each one comes with its own perks (for example, all Early applicants are ',
                               ...
                               answer :
                                   React
                                       .createElement('span', null,
                                                      'Absolutely nothing on your end!  We provide food, swag, workspace, and WiFi for your entire 24 hours. Not only will we cover you for the weekend, ',
                                                      React.createElement(
                                                          'b', null,
                                                          'we can even help some people cover travel.'),
                                                      ' That\u2019s right! Here at B4H we want to make things as accessible as possible for those who need it. For more info, see the FAQ below!')
                             }),
                             React.createElement(QuestionBox, {
                               question :
                               ...
                               answer :
                                   React.createElement(
                                       ...
                                       React.createElement(
                                           'b', null,
                                           'If you apply through Early, you qualify for up to $50 in travel reimbursement if you are outside of NYC!'),
                                       React.createElement('br', null),
                                       React.createElement('br', null),
                                       ...
                                       React
                                           .createElement(
                                               'b', null,
                                               'For our other application rounds, we will be considering factors such as family income and demographic underrepresentation, so low income students or underrepresented minorities are especially encouraged to apply.  We will try to accommodate everyone with at least partial reimbursement if they are outside of the NYC area, subject to a sliding scale. '),
                                       React.createElement('br', null),
                                       React.createElement('br', null),
                                       'For high school students, we\u2019re happy to announce we\u2019ve partnered with ',
                                       React.createElement('b', null, 'Execute Big'), ' to provide travel reimbursements! Once you fill out the form and we determine you\u2019re eligible, your information be passed on to them for consideration (if you apply through Regular or Late)! If you are accepted, congratulations! You\u2019ll be covered at least in part by Execute Big. If you aren\u2019t accepted, you will then be considered for reimbursement by our team.',
                                       React.createElement('br', null),
                                       React.createElement('br', null),
                             ...
                             React.createElement(QuestionBox, {
                               ...
                               answer : React.createElement(
                                   'span', null,
                                   'Bring a photo ID, your laptop and charger, a change of clothes, toiletries, a sleeping bag/blanket, your hacker setup, and yourself!')
                             }),
                             React.createElement(QuestionBox, {
                               question :
                                 ...
                                 QuestionBox, {
                                   ...
                                   answer : React.createElement(
                                       ...
                                       React.createElement(
                                           'a', {
                                             href :
                                                 'mailto:hackathon@blockchainsforschools.org'
                                           },
                                           'hackathon@blockchainsforschools.org'))
                                 }));
}
